...
// TODO: ROWS DO NOT HAVE PROPER ALIGNMENT
// MARK: - View
      ...
      Group {
        Section {
          ...
          HStack {
            ...
            .contentShape(Rectangle())
            .onTapGesture {
              viewStore.send(.delegate(.sectionNavigationAreaTapped), animation: .default)
            }
            Spacer()
            Image(systemName: "chevron.right")
              .rotationEffect(viewStore.isExpanded ? .degrees(90) : .degrees(0))
