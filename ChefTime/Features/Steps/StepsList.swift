...
//          stepSection: [],
//          isExpanded: true,
//          focusedField: nil // TODO: Which value?
//         )
...
//              .init(
//                id: .init(),
//                stepSection: .init(uniqueElements: section.steps.map({ step in
//                    .init(
//                      id: .init(),
//                      stepSection: <#T##IdentifiedArrayOf<StepSectionReducer.State>#>,
//                      isExpanded: <#T##Bool#>,
//                      focusedField: <#T##StepSectionReducer.FocusField?#>
//                    )
//                })),
//                isExpanded: true,
//                focusedField: nil
...
//          ),
////          initialState: .init(
////            stepSections: .init(uniqueElements: Recipe.longMock.stepSections.map({
////              .init(id: .init(), stepSection: $0, isExpanded: true)
////            })),
////            isExpanded: true
////          ),
